...
```bash
next, lucide-react, @radix-ui/react-icons, class-variance-authority, @radix-ui/react-navigation-menu, @radix-ui/react-slot, @radix-ui/react-dialog, @radix-ui/react-label, @radix-ui/react-accordion, cmdk
```
